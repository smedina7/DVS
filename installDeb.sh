...
REQUIRED_PYTHON_PACKAGES="PyQt5==5.15.1 plotly dash Flask pandas flask_caching PyQtWebEngine virtualenv dash_daq"
...
sudo pip install dash==1.8.0 
sudo pip install dash-bootstrap-components==0.10.7rc1
