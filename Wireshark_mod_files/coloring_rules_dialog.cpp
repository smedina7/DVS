...
void ColoringRulesDialog::colorize_button_clicked()
{
    QString err;
    colorRuleModel_.removeRows(0, colorRuleModel_.rowCount());
    QString file_name = "/home/kali/eceld-wireshark/wireshark-3.2.0/profiles/DVS/colorfilters";
    colorRuleModel_.importColors(file_name, err);
    checkUnknownColorfilters();
