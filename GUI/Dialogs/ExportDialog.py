...
class ExportDialog(QtWidgets.QDialog):
    def __init__(self, parent, project_path):
        ...
        self.project_data_path = os.path.dirname(self.project_path)
        ...
        self.exportLabel = QLabel("Exporting Project Settings")
        labelFont = QtGui.QFont()
        labelFont.setBold(True)
        self.exportLabel.setFont(labelFont)
        self.exportLabel.setAlignment(Qt.AlignCenter)
        self.labelVerBoxPro.addWidget(self.exportLabel)
