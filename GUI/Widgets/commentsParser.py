...
class commentsParser:
    def __init__(self, path):   
        ...
        if os.path.isfile(file_path):
            ...
            file.truncate(0)
            command = "tshark -r /home/kali/DVS_dev/ProjectData/t0/PCAP/AnnotatedPCAP.pcapng -Y frame.comment -T fields -E header=y -e frame.number -e frame.comment -e frame.time >> /home/kali/DVS_dev/GUI/Widgets/pcomments.txt"
            os.system(command)
